            ...
            <div className="flex items-center justify-center min-h-screen rounded-full drop-shadow-xl">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 glass drop-shadow-xl">
                    <div className="artboard phone-3 flex flex-col items-start justify-start w-full mx-4 p-4">
                        <div className="card shrink-0 w-full max-w-sm h-full shadow-md bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% border-t-4 border-b-4 border-black">
                            <form className="p-6 space-y-6 bg-gradient-to-r from-emerald-500 via-sky-500 to-violet-700 border-t-8 border-b-8 border-black rounded-lg shadow-lg" onSubmit={handleRegisterUserRequestAndResponse}>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-1 gap-4 drop-shadow-xl">
                                    {/* First Name Field */}
                                    ...
                                    <div className="form-control mt-6">
                                        <button type="submit" className="btn drop-shadow-2xl bg-gradient-to-r from-zinc-100 to-black-100 hover:from-black hover:to-zinc-400 text-black hover:text-black text-2xl">Register</button>
                                    </div>
                                    <center>
