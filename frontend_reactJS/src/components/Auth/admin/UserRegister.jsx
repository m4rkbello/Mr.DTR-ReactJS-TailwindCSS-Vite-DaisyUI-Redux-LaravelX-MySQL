                                ...
                                <div className="grid grid-cols-1 md:grid-cols-1 gap-2 drop-shadow-xl">
                                    ...
                                    <div className="form-control">
                                        ...
                                        <input
                                            ...
                                            className="input input-bordered grow glass text-white placeholder-white"
                                            required
                                        />
                                    </div>
                                    {/* Last Name Field */}
                                    ...
                                    <div className="form-control mt-6">
                                        <button
                                            type="submit"
                                            className="btn drop-shadow-2xl bg-gradient-to-r from-zinc-100 to-black-100 hover:from-black hover:to-zinc-400 text-white hover:text-white text-2xl"
                                        >
                                            Register
                                        </button>
                                    </div>
